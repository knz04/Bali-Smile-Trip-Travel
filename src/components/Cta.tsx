...
export default function Cta() {
  return (
    <div className="relative flex items-center justify-center py-12 sm:h-fit lg:h-[24vh] lg:p-0">
      <img
        src={ctaImage}
        alt="CTA Image"
      ...
      <div className="relative flex w-full flex-col items-center justify-center gap-y-4 lg:w-[80%] lg:flex-row lg:justify-around lg:gap-0">
        <div className="flex w-[90%] flex-col items-center gap-y-2 lg:w-[50%] lg:items-start">
          <p className="text-background text-center sm:text-3xl lg:text-left lg:text-4xl">
            Let Us Be Your Local Friend in Bali
          </p>
          <p className="text-background w-full text-center font-light sm:text-base lg:w-[60%] lg:text-left lg:text-lg">
