  ...
  return (
    ...
    >
      ...
      <img
        ...
        alt="Logo"
        className="absolute top-8 left-1/2 h-[30%] -translate-x-1/2 lg:top-1/2 lg:left-0 lg:h-[75%] lg:translate-x-1/10 lg:-translate-y-3/5"
      />
      ...
      <div className="absolute inset-y-0 right-0 hidden w-1/2 lg:block">
        {lines.map((line, i) => (
          <p
            key={i}
            className="text-primary absolute lg:text-xl xl:text-2xl 2xl:text-3xl"
            style={{
              top: `${10 + i * 9}%`,
              left: `${arcOffsets[i]}%`,
            }}
