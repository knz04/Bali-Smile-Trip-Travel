...
export default function Welcome() {
  return (
    <div className="flex w-full flex-col items-center justify-center gap-y-8 py-2 sm:h-screen lg:h-[50vh] lg:flex-row lg:gap-x-8">
      <div className="flex">
        <img src={welcome} alt="Welcome" className="w-full sm:h-64 lg:h-96" />
      </div>
      <div className="flex w-[90%] flex-col gap-y-4 lg:w-[40%]">
        <p className="text-start sm:text-3xl lg:text-4xl">
